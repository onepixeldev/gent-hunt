															...
															echo '<tr>
																	...
																	<div>
																		...
																		<form action="entMoreInfoAdmin.php" method="POST" style="margin-bottom:0px">
																			...
																			<button type="submit" name="submitUp" style="background-color: #179BD7; width: 42%; height: 30px; font-size: 10px; padding: 0px 0px 0px 0px;" class="btn btn-warning btn-lg">More Details</button>
																		</form>
