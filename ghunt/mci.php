                ...
                <div class="row">
							<div class="col-md-12">
								<div class="box box-info">
									...
									<div class="box-body">
											<form action="updateMCI.php" method=""> 
												...
												<div class="panel panel-default">
													<div class="panel-body">
														<div class="job-details" style="width: 100%; float: left; text-align:left">
															<div> 
																<span class="thumbnail no-bottom-margin" style="width: 93; height: 100px;">
															...
															echo'<div>
																	<span style=" display:inline-block; width: 50%;">
																			<p> <strong>Location<span></span>:</strong><br> '.$ci['location'].' </p>
																			<br>
																			<p> <strong>Tel<span></span>:</strong> '.$ci['tel_no'].' </p>
																		
																			<p> <strong>Email<span></span>:</strong> '.$ci['email'].' </p>
																		
																			<p> <strong>Fax <span></span>:</strong> '.$ci['fax'].' </p>
																	</span>
																</div>';
