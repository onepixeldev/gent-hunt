<?php
	...
	$query=mysqli_query($link,"SELECT count(idcm) FROM `coach-mentor` WHERE name LIKE '%$search%' OR email LIKE '%$search%' OR position LIKE '%$search%'");
	...
	$nquery=mysqli_query($link,"SELECT * FROM `coach-mentor` WHERE name LIKE '%$search%' OR email LIKE '%$search%' OR position LIKE '%$search%' ORDER BY name ASC $limit");
